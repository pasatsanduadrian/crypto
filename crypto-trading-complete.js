        ...
        resultsDiv.innerHTML = `
            <div class="safety-report ${riskClass}">
                ...
                <div class="safety-metrics">
                    ...
                    <div class="safety-metric">
                        <span>LP Locked:</span>
                        <strong class="${safety.lpLocked ? 'safe' : 'danger'}">${safety.lpLocked ? 'Yes âœ“' : 'No âœ—'}</strong>
                    </div>
                    <div class="safety-metric">
                        <span>Honeypot:</span>
                        <strong class="${!safety.honeypot ? 'safe' : 'danger'}">${safety.honeypot ? 'DETECTED âš ï¸' : 'No âœ“'}</strong>
                    </div>
                    <div class="safety-metric">
                        <span>Mintable:</span>
                        <strong class="${!safety.mintable ? 'safe' : 'warning'}">${safety.mintable ? 'Yes âš ï¸' : 'No âœ“'}</strong>
                    </div>
                    <div class="safety-metric">
                ...
                ${!safety.safe ? `
                    <div class="safety-warning">
                        <strong>âš ï¸ Warning:</strong> ${safety.reason}
                    </div>
                ` : ''}
            </div>
        `;
